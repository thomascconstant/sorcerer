...
var toursDeJeu = 20; //Nbre de tours de jeu total, variable à modifier pour augmenter ou réduire le temps de jeu si overideTestMode = false
    ...
    if (miseValide === true && confianceValide === true && countDownToZero === true && casesFound.indexOf(ijFind) < 0) {
      ...
      casesFound.push(ijFind);
        if(nbCasesToFind <= 0) {
            ...
            resultatJoueur += getDateTime() + ";" + nomJoueur + ";" + IDjoueur + ";" + connexionJoueur + ";" + nomDuJeu + ";" + modeTest + ";" + miseFirst + ";" + actionDeJeu + ";" + differencePlayTime + ";" + mise + ";" + confiance + ";" + diffModel.currentDiff.toFixed(2) + ";" + g_nbPerm + ";" + g_nb_coups + ";" + compteurMoutonsGagnes + ";" + compteurMoutonsPerdus + ";" + score + ";" + winState + ";" + "\n";
