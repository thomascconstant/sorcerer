...
function recupConfiance() {
    if (nbDeClics === 0) {
        if (isNaN(confiance)) {
            ...
            setTimeout(function erazeConfiance() {
                launchFadeOutConfiance();
                //restartAnimateScoreMoutons();
            }, 100);
...
function results() {
    if (winState && confianceValide && miseValide) {
        win();
        endTurn = true;
    }
    
    if (winState === false && confianceValide && miseValide) {
        fail();
        endTurn = true;
    }
}
...
function win() {
    if (miseValide && confianceValide && nbCasesToFind <= 0) {
        winState = true;
        ...
        resultatJoueur += getDateTime() + ";" + nomJoueur + ";" + IDjoueur + ";" + connexionJoueur + ";" + nomDuJeu + ";" + modeTest + ";" + miseFirst + ";" + actionDeJeu + ";" + differencePlayTime + ";" + mise + ";" + confiance + ";" + diffModel.currentDiff.toFixed(2) + ";" + nbCells + ";" + nbCasesToFind + ";" + compteurMoutonsGagnes + ";" + compteurMoutonsPerdus + ";" + score + ";" + winState + ";" + "\n";
...
function makeGameNoColors(width,nbCellsX,diffColor) {
    ...
    var colorFindR = Math.floor(colorBaseR + Math.max(20,100 * diffColor));
    var colorFindV = Math.floor(colorBaseV + Math.max(20, 100 * diffColor));
    var colorFindB = Math.floor(colorBaseB + Math.max(20, 100 * diffColor));
