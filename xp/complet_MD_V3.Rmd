...
if(TEST){
  ...
  #------------------ erreur mise par rapport à la difficulté (selon profil gamer du participant)
  DTLocGamer <- DTLoc[meanProfilJoueur>=3]
  model <- lmer(DTLocGamer$erreurMise ~ DTLocGamer$difficulty + (1 | DTLocGamer$IDjoueur))
  summary(model)
  r.squaredGLMM(model)
  
  #------------------ erreur mise par rapport à la difficulté (selon profil non-gamer du participant)
