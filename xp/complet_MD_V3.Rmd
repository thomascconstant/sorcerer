...
if(TEST){
  ...
  #=================== erreur mise par rapport à la difficulté
  model <- lmer(DTLoc$erreurMise ~ DTLoc$difficulty + (1 | DTLoc$IDjoueur))
  summary(model)
  r.squaredGLMM(model)
  predict(model)
  
  #------------------ erreur mise par rapport à la difficulté logique
  ...
  #------------------ erreur mise par rapport à la difficulté motrice
  ...
  #------------------ erreur mise par rapport à la difficulté sensorielle
  ...
  #=================== erreur mise selon profil du participant
  model <- lmer(DTLoc$erreurMise ~ DTLoc$meanProfilJoueur + (1 | DTLoc$IDjoueur))
  summary(model) #nope
  
  #=================== erreur mise selon profil gamer du participant
  ...
  #=================== erreur mise selon profil non-gamer du participant
  ...
  #=================== erreur mise selon profil risquophobe du participant
  ...
  #=================== erreur mise selon profil risquophile du participant
  ...
  model <- lmer(DTLocMen$erreurMise ~ DTLocMen$meanProfilJoueur + (1 | DTLocMen$IDjoueur))
  summary(model) #pas d'impact lié au sexe
