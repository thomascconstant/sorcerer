...
if(TEST){
  ...
  #COMMENT FAIRE CORRELER DEUX TABLEAUX QUI N'ONT PAS LES MEMES NOMBRES DE DONNEES ?
  total <- merge(DTLoc,DTQLoc,by="idJoueur") #changer IDjoueur dans les deux tables
  DTQLoc <- dataQ
