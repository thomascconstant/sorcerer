...
```{r echo=FALSE}
#------------------------------------------------------------------------------------------------
#        INFLUENCE OF PLAYERS' PROFILES ON PLAYERS' DIFFICULTY ESTIMATION (BASED ON BET)
#------------------------------------------------------------------------------------------------

#ATTENTION, CACUL BASE SUR LA MISE : error.subj.diff.mise.mean

#--------------------------------------------------------------------------------------------
#        INFLUENCE OF VIDEO GAME EXPERTISE ON PLAYERS' DIFFICULTY ESTIMATION (BET)
#--------------------------------------------------------------------------------------------
...
```{r echo=FALSE}
#--------------------------------------------------------------------------------------------
#        INFLUENCE OF BOARD GAME EXPERTISE ON PLAYERS' DIFFICULTY ESTIMATION (BET)
#--------------------------------------------------------------------------------------------
...
```{r echo=FALSE}
#----------------------------------------------------------------------------------
#        INFLUENCE OF IN GAME LEVEL ON PLAYERS' DIFFICULTY ESTIMATION (BET)
#----------------------------------------------------------------------------------
...
```{r echo=FALSE}
#----------------------------------------------------------------------------------
#        INFLUENCE OF SEX AND LEVEL ON PLAYERS' DIFFICULTY ESTIMATION (BET)
#----------------------------------------------------------------------------------
...
```{r echo=FALSE}
#----------------------------------------------------------------------------------
#        INFLUENCE OF RISK AVERSION ON PLAYERS' DIFFICULTY ESTIMATION (BET)
#----------------------------------------------------------------------------------
...
```{r echo=FALSE}
#----------------------------------------------------------------------------------
#        INFLUENCE OF SELF EFFICACY ON PLAYERS' DIFFICULTY ESTIMATION (BET)
#----------------------------------------------------------------------------------
...
```{r plot.subjective.objective.difficulty.bet, echo=FALSE}   
#------------------------------------------------------------------------
#     SHOWING SUBJECTIVE VS OBJECTIVE DIFFICULTY (BET APPROACH)
#------------------------------------------------------------------------
...
```{r plot.subjective.difficulty.all.bet, echo=FALSE}
...
obj.diff.mean = numeric(nb.bins)
  ...
  for(i in 1:nb.bins){
    ...
    subj.diff = DTLoc$subj.diff.mise
...
```{r platytime.subjective.difficulty.all.tasks, echo=FALSE} 
plot.subjective.diff.error.density(DTAll[niveau.group=="bad"])
summary(glm(error.subj.diff.mise~timeNorm + obj.diff,data = DTAll[niveau.group=="bad"]))
plot.subjective.diff.error.density(DTAll[niveau.group=="medium"])
summary(glm(error.subj.diff.mise~timeNorm + obj.diff,data = DTAll[niveau.group=="medium"]))
plot.subjective.diff.error.density(DTAll[niveau.group=="good"])
summary(glm(error.subj.diff.mise~timeNorm + obj.diff,data = DTAll[niveau.group=="good"]))
